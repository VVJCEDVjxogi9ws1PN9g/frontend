...
app.controller('myCtrl', ['$scope', '$window', '$timeout', '$interval', '$sce', function($scope, $window, $timeout, $interval, $sce) {
	...
	$scope.mapIcons = [
		{icon: './images/level1.png', exp: 'Unclaimed Land', rating: 3, classes: 'thin-border'},
		{icon: './images/level2.png', exp: 'Unclaimed Land', rating: 2, classes: ''},
		{icon: './images/level3.png', exp: 'Unclaimed Land', rating: 1, classes: ''},
		
		{icon: './images/flag1.png', exp: 'Land owned by others', rating: 3, classes: 'blue darken-4'},
		...
		{icon: './images/mine1.png', exp: 'Land owned by you', rating: 3, classes: 'blue darken-4'},
	...
	// tutorials
	$scope.tuts = [
		{ title: 'Full Tutorial', desc: 'Watch the complete step-by-step tutorial', icon: 'videocam', link: $sce.trustAsResourceUrl('https://www.youtube.com/watch?v=D5Z35PzQxEY') },
		{ title: 'Connect Wallet', desc: 'Learn how to connect a Web3 or Mobile wallet to the application.', icon: 'account_balance_wallet', link: $sce.trustAsResourceUrl('https://youtu.be/D5Z35PzQxEY?t=18') },
		{ title: 'Claiming LAND', desc: 'Learn how to claim LAND units that are not bought by other players yet.', icon: 'flag', link: $sce.trustAsResourceUrl('https://youtu.be/D5Z35PzQxEY?t=62') },
		{ title: 'Making Offers', desc: 'Learn how to make offers to buy LAND owned by other players.', icon: 'new_releases', link: $sce.trustAsResourceUrl('https://youtu.be/D5Z35PzQxEY?t=332') },
		{ title: 'Selling LAND', desc: 'Learn how to view and accept offers made by other player to buy your LAND.', icon: 'thumb_up', link: $sce.trustAsResourceUrl('https://youtu.be/D5Z35PzQxEY?t=410') },
		{ title: 'Installing Miner', desc: 'Learn how to install and update a mining equipment on your LAND.', icon: 'build', link: $sce.trustAsResourceUrl('https://youtu.be/D5Z35PzQxEY?t=219') },
		{ title: 'Claim Mining Rewards', desc: 'Learn how to claim daily mining rewards on your LAND.', icon: 'monetization_on', link: $sce.trustAsResourceUrl('https://youtu.be/D5Z35PzQxEY?t=458') },
	];
